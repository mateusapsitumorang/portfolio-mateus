...
const ProjectSection = (props) => {
    ...
    return (
        <div className="wpo-project-area section-padding" id='portfolio'>
            ...
            <ProjectSingle open={open} onClose={handleClose} title={state.title} pImg={state.ps1img} psub1img1={state.psub1img1} psub1img2={state.psub1img2} description={state.description} location={state.location} duration={state.duration} completion={state.completion} ourapproach={state.ourapproach} programminglanguague={state.programminglanguague} framework={state.framework} database={state.database} library={state.library} platform={state.platform} />
        </div>
    );
}
