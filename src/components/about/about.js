                    ...
                    <div className="col-lg-5 col-md-12 col-sm-12">
                        <div className="wpo-about-exprience-wrap">
                            ...
                            <div className="client">
                                ...
                                <p>Ready to Provide the Best Service</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 offset-lg-1 col-md-12 col-sm-12">
                        <div className="wpo-about-content">
                            <div className="wpo-about-title">
                                <h2>My Superiority</h2>
                                <p>I excel in the fields of IT and design, 
                                    combining technical expertise with visual creativity to deliver functional 
                                    and visually compelling solutions.</p>
                            </div>
                            <div className="wpo-about-funfact">
                                ...
                                <div className="grid">
                                    <div className="grid-inner">
                                        <h3><span data-count="96">96</span>%</h3>
                                        <p>Canva</p>
                                    </div>
                                </div>
                                <div className="grid">
