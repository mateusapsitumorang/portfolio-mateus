...
import cv from '../../images/CV Mateus Appuwan Situmorang.pdf'
                            ...
                            <div className="col-lg-8 col-md-1 col-1">
                                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li>
                                            <Link activeClass="active" to="blog" spy={true} smooth={true}  duration={500}>Certificate</Link>
                                        </li>
                                    </ul>
                            ...
                            <div className="col-lg-2 col-md-2 col-2">
                                <div className="header-right">
                                    <div className="header-btn">
                                        <a onClick={ClickHandler} className="theme-btn" download="Cv-Mateus Appuwan Situmorang" href={cv}
                                            title="ImageName">
