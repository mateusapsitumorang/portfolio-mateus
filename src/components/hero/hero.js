...
import icon1 from '../../images/icon/python.svg'
import icon2 from '../../images/icon/react.svg'
import icon3 from '../../images/icon/postgre.svg'
import icon4 from '../../images/icon/premiere.svg'
                            ...
                            <div className="col-xl-6 col-lg-6 col-12">
                                <div className="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="400" className="slide-text">
                                        <p>I specialize in System Development, crafting innovative and efficient solutions to meet diverse technological needs. 
                                            Passionate about creating seamless and scalable systems, 
                                            I bring a strong focus on quality and user experience in every project I undertake.</p>
                                    </div>
            ...
            <div className="static-hero-right">
                <div className="static-hero-img">
                    <div className="static-hero-img-inner">
                        ...
                        <div className="icon-4 floating-item"><img src={icon4} alt="" /></div>
                    </div>
                </div>
            </div>
